...
app.get('/incidents', async (req, res) => {
    try {
        ...
        if (req.query.limit != undefined && req.query.limit.length > 0) {
            limit = req.query.limit
        } else {
            limit = 1000
        }

        if (req.query.start_date != undefined && req.query.start_date.length > 0) {
            start_date = req.query.start_date
        } else {
            start_date = '0000-00-00'
        }

        if (req.query.end_date != undefined && req.query.end_date.length > 0) {
        ...
        if (req.query.grid != undefined && req.query.grid.length > 0) {
        ...
        if (req.query.neighborhood != undefined && req.query.neighborhood.length > 0) {
